...
def post_ingrediente():
  try:
    ...
    cursor.execute(f"SELECT * FROM ingrediente WHERE ingrediente_id = '{data['ingrediente_id']}';")
    ingrediente = cursor.fetchone()
    ingrediente = {
      "ingrediente_id": ingrediente[0],
      "nombre": ingrediente[1],
...
def put_ingrediente(ingrediente_id):
  try:
    ...
    cursor.execute(f"SELECT * FROM ingrediente WHERE imgrediente_id = '{imgrediente_id}';")
    ingrediente = cursor.fetchone()
    ingrediente = {
